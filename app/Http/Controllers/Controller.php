...
class Controller extends BaseController
{
    ...
    {
        if (request()->ajax()) {
            return Datatables::of(User::where('role',3)->get())->addIndexColumn()->addColumn('aksi', function ($data) {
    ...
    {
        if (request()->ajax()) {
            return Datatables::of(User::where('role',2)->get())->addIndexColumn()->addColumn('aksi', function ($data) {
                $dataj = json_encode($data);
                $btn = "<ul class='list-inline mb-0'>
                <li class='list-inline-item'>
                <button type='button' data-toggle='modal' onclick='staffupd(" . $dataj . ")'   class='btn btn-success btn-xs mb-1'>Edit</button>
    ...
    {
        if (request()->ajax()) {
            return Datatables::of(User::where('role',1)->get())->addIndexColumn()->addColumn('aksi', function ($data) {
                $dataj = json_encode($data);
                $btn = "<ul class='list-inline mb-0'>
                <li class='list-inline-item'>
                <button type='button' data-toggle='modal' onclick='staffupd(" . $dataj . ")'   class='btn btn-success btn-xs mb-1'>Edit</button>
