                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="float-left">
                                <h4>Manajemen Data Materi File - {{ $user->oMateri->nama_materi }}</h4>
    ...
    <script>
        ...
        jQuery(document).ready(function() {
            ...
            tabel = $("#dt").DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: url + '/admin/data-materi/' + "{{ $user->id }}" + '/file',
                },
                columns: [{
                        nama: 'DT_RowIndex',
                        data: 'DT_RowIndex'
        ...
        function staffdel(id) {
            ...
            if (data) {
                ...
                $.ajax({
                    url: url + '/admin/data-materi/' + id +'/file',
                    type: "delete",
                    success: function(e) {
                        $.LoadingOverlay("hide");
                        if (e == 'success') {
