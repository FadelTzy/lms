...
@section('title')
    Data Materi Video Pembelajaran
@endsection
@section('content')
    <section class="section">
        <div class="section-header">
            <h1> Mata Kuliah : {{ $user->oMatkul->kode_mk }} - {{ $user->oMatkul->nama_mk }}
            </h1>
        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="float-left">
                                <h4>Manajemen Data Materi Video - {{ $user->oMateri->nama_materi }}</h4>

                            </div>
                            <div class="float-right">
                                <div class="section-header-button">
                                    <a  href="{{url('admin/data-materi') . '/' . $user->id}}"
                        ...
                        <form id="dataperiode" method="POST">
                            <div class="card-body">
                                ...
                                <input type="hidden" name="nama_mk"
                                    value="{{ $user->oMatkul->kode_mk }} - {{ $user->oMatkul->nama_mk }}">
                ...
                <div class="modal-body">
                    <form id="dataperiodeu" method="POST">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label for="Nama">Link</label>
                                <input type="text" name="link" id="linku" class="form-control">
    ...
    <script>
        ...
        jQuery(document).ready(function() {
            ...
            tabel = $("#dt").DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: url + '/admin/data-materi/' + "{{ $user->id }}" + '/video',
                },
                columns: [{
                        nama: 'DT_RowIndex',
                        data: 'DT_RowIndex'
        ...
        function staffdel(id) {
            ...
            if (data) {
                ...
                $.ajax({
                    url: url + '/admin/data-materi/' + id +'/video',
                    type: "delete",
                    success: function(e) {
                        $.LoadingOverlay("hide");
                        if (e == 'success') {
